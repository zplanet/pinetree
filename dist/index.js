...
exports.init = exports.mutate = exports.subscribe = exports.getState = undefined;

var _immer = __webpack_require__(8);
...
var subscribe = function subscribe(fn) {
    ...
    subscribers.push(fn);
    return function () {
        subscribers = subscribers.filter(function (sfn) {
            return sfn !== fn;
        });
    };
};

var mutate = function mutate(fn) {

    if (typeof fn !== 'function') {
        throw new Error('first argument should be a function');
    }

    var newState = (0, _immer2.default)(getState(), fn);

    setState(newState);

    subscribers.forEach(function (sfn) {
        sfn(newState);
    });
};
...
var _ReactWrapper = __webpack_require__(9);

Object.keys(_ReactWrapper).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _ReactWrapper[key];
    }
  });
});
...
var connect = function connect(filter, mutator) {
    return function (WrapperComponent) {
        return function (_Component) {
            ...
            function _class(props) {
                ...
                _this.state = filter ? filter((0, _Store.getState)()) : {};
                _this.m = mutator ? Object.assign({ mutate: _Store.mutate }, mutator(_Store.mutate)) : { mutate: _Store.mutate };
                return _this;
            }
            ...
            _createClass(_class, [{
                ...
                value: function componentDidMount() {
                    ...
                    this.unsubscribe = filter ? (0, _Store.subscribe)(function (state) {
                        return _this2.setState(filter(state));
                    }) : null;
                }
            }, {
                ...
                value: function render() {
                    var newProps = Object.assign({}, this.state, this.m);
                    return _react2.default.createElement(WrapperComponent, newProps);
                }
            }]);
